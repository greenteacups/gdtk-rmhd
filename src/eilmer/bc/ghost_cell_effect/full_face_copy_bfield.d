// full_face_copy_bfield.d

module bc.ghost_cell_effect.full_face_copy_bfield;
...
class GhostCellFullFaceCopyBField : GhostCellEffect {
public:
    ...
    {
        super(id, boundary, "FullFaceCopyBField");
    ...
    {
        string str = "FullFaceCopyBField(otherBlock=" ~ to!string(neighbourBlock.id) ~
    ...
    void exchange_viscous_gradient_phase2(double t, int gtl, int ftl)
    {
        version(mpi_parallel) {
            ...
            foreach (i; 0 .. ghost_cells.length) {
                ...
                ghost_cells[i].grad.B = mapped_cells[i].grad.B;
            }
        }
    ...
    {
	throw new Error("GhostCellFullFaceCopyBField.apply_for_interface_unstructured_grid() not implemented");
    }

    @nogc
    override void apply_unstructured_grid(double t, int gtl, int ftl)
    {
        throw new Error("GhostCellFullFaceCopyBField.apply_unstructured_grid() not implemented");
    }

    override void apply_for_interface_structured_grid(double t, int gtl, int ftl, FVInterface f)
    {
	throw new Error("GhostCellFullFaceCopyBField.apply_for_interface_structured_grid() not implemented");
    }
...
} // end class GhostCellFullFaceCopyBField
